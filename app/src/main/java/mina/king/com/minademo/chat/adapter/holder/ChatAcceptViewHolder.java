package mina.king.com.minademo.chat.adapter.holder;
...
import mina.king.com.minademo.chat.widget.BubbleImageView;
import mina.king.com.minademo.chat.widget.BubbleLinearLayout;
import mina.king.com.minademo.chat.widget.GifTextView;
...
public class ChatAcceptViewHolder extends BaseViewHolder<MessageInfo> {
    ...
    public void setData(MessageInfo data) {
        ...
        Glide.with(mContext).load(UserInfoCache.getUserInfo(UserInfoCache.HEAD_OTHER_IMAGE)).into(chatItemHeader);
